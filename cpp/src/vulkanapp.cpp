...
private:
  ...
  void createGraphicsPipeline() {
    auto vertShaderCode = readFile("../shaders/out/shaders.vert.spv");
    auto fragShaderCode = readFile("../shaders/out/shaders.frag.spv");
  ...
  void drawFrame() {
    ...
    imagesInFlight_[imageIndex] = inFlightFences[currentFrame_];
